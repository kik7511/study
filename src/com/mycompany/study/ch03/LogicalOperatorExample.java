...
public class LogicalOperatorExample {
	...
	public static void main(String[] args) {
		...
		if(a >= 66 | a <=50) {
			System.out.println("둘다 폴스라서 이글은 보이지 않아야 함");
		}
		...
		if(a>=65^a<=50) {
			System.out.println("이렇게 해야 보여진다");	//한개만 참
		}
			
		if(a>=60^a<=64) {
			System.out.println("보아라");	//한개만 참
		}
		
		if(a>=66^a<=70) {
			System.out.println("나와라");	//한개만 참			
		}
		
		if(a>=65^a<=70) {
			System.out.println("이건 안나옴");	//둘다 참			
		}
