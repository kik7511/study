...
public class tr {
    ...
    public static void main(String[] args) {
        ...
        while(isSameNumber || isLinearNumber || isSameNumber){
            ...
            randomString = randomString.substring(beginIndex: 0, randomString.length()-1);
            ...
            if(isSameNumber || isLinearNumber || isSameOldNumber){
                System.out.println("재도전: " + randomString);
            }else{
                System.out.println("꼭 되시기를 " + randomString);
            }
